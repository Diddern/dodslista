...
const Rulebook = () => (
    <div className="rulebook">
        <h2>Regelverk for Dødslisten</h2>
        <p><strong>Versjon 1.0 – Gjeldende for inneværende år</strong></p>

        <h3>§1 – Generelle bestemmelser</h3>
        <p>1.1. Dette regelverket regulerer spillernes deltakelse i "Dødslisten" og er bindende for alle deltakere.</p>
        ...
        <ul>
            ...
            <li>b) Kandidaten må ha en <strong>eksisterende Wikipedia-side</strong> ved tidspunktet for valg av liste.</li>
            <li>c) Kandidatens død må <strong>kunne bekreftes i riksdekkende medier</strong>.</li>
        </ul>
        <p>4.2. Begge spillere kan <strong>ikke</strong> ha samme kandidat på sin liste.</p>
        <p>4.3. Dersom begge spillere ønsker samme kandidat, har spilleren som hadde kandidaten på sin liste året før <strong>førsterett</strong> til å velge vedkommende.</p>
        <p>4.4. Ved uenighet om valg av kandidat mellom to spillere skal dette avgjøres ved <strong>steinsaks-papir (best av tre)</strong>.</p>
        ...
        <p>5.3. Hvis en spiller ikke utøver sin førsterett innen fristen, er kandidaten åpen for valg av den andre spilleren.</p>
